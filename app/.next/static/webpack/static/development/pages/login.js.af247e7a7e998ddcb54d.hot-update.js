...
function (_Component) {
  ...
  function Login() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "login", function () {
      aws_amplify__WEBPACK_IMPORTED_MODULE_9__["Auth"].signIn(_this.state.username, _this.state.password).then(function (data) {
        return _this.props.client.writeData({
          data: {
            user: {
              email: data.email
            }
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_apollo__WEBPACK_IMPORTED_MODULE_10__["withApollo"])(Login));

/***/ })

})
//# sourceMappingURL=login.js.af247e7a7e998ddcb54d.hot-update.js.map