...
var awsmobile = {
  ...
  "aws_cognito_identity_pool_id": "eu-west-1:fb729ac4-1006-44c6-b4b7-ae9e8426b684",
  "aws_cognito_region": "eu-west-1",
  "aws_user_pools_id": "eu-west-1_okBxBhKxm",
  "aws_user_pools_web_client_id": "38knj919bq0f8eds3p17tlpqj0",
  "oauth": {}
};
...
var getToken = function getToken() {
  ...
  if (typeof document !== 'undefined') {
    token = 'Bearer ' + js_cookie__WEBPACK_IMPORTED_MODULE_3___default.a.get('token');
  }
...
function create(initialState) {
  var authMiddleware = new apollo_link__WEBPACK_IMPORTED_MODULE_1__["ApolloLink"](function (operation, forward) {
  ...
  var httpLink = new apollo_boost__WEBPACK_IMPORTED_MODULE_0__["HttpLink"]({
    uri: 'https://hasura-next.herokuapp.com/v1/graphql',
  ...
  return new apollo_boost__WEBPACK_IMPORTED_MODULE_0__["ApolloClient"]({
    ...
    link: Object(apollo_link__WEBPACK_IMPORTED_MODULE_1__["concat"])(authMiddleware, httpLink),
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 16:
                  ...
                  next_server_head__WEBPACK_IMPORTED_MODULE_12___default.a.rewind();
